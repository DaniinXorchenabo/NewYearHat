...
<div class="de de1" id="d2" style="display: inline-block;">  </div>	
...
<div class="de de1" id="d1" style="display: inline-block;"></div>
	</div></div>
	
<div class="de1" id="de3">опастность</div>		
<div class="f1">
...
<button type="button" onclick="sendData2(0)" style="display:none" id="a4" class="qe qw" >LED ON1</button></div>
  ...
  </div><div><span id="DENG1Value">0</span></div>
...
function getData(cc1) {
  ...
  xhttp.onreadystatechange = function() {
    ...
    for(i=0;i<100;i++){
      i2=i2+0.01;
    document.getElementsByClassName("de1").style.opacity= i2;}
	               }
	if (a == "3"){
		var i;
    var i1;
    ...
    for(i=0;i<100;i++){
    i1=i1-0.01;
		document.getElementsByClassName("de1").style.opacity= i1;}
	             }
	           }
    }
  }
